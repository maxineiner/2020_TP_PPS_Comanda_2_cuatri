...
let ListaDeEsperaPage = class ListaDeEsperaPage {
    ...
    asignarMesa(mesa) {
        ...
        this.pedidosService.crear(src_app_clases_pedido__WEBPACK_IMPORTED_MODULE_4__["Pedido"].CrearPedido('', this.clienteActual, mesa, null, Date.now(), null, null, src_app_clases_pedido__WEBPACK_IMPORTED_MODULE_4__["EstadoPedido"].RESERVADO, true)).then(() => {
