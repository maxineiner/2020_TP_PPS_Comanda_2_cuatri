...
module.exports = __webpack_require__(/*! /home/aleksei/workspace/Trabajo_Practico_2_PPS/2020_TP_PPS_Comanda_2_cuatri/src/main.ts */"zUnb");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-content class=\"ion-padding contenido\" *ngIf=\"mensajes\" #content>\n\n  <ion-grid fixed *ngFor=\"let mensaje of mensajes; let i = index\" color=\"primary\">\n\n    <ion-row *ngIf=\"idUsuario != mensaje.usuario.id\">\n\n      <ion-col size=\"12\">\n\n        <div class=\"ion-text-start mensaje-ajeno\">\n\n          <ion-chip color=\"dark\" mode=\"ios\">\n            <ion-label>Servicio - {{mensaje.fecha | date: 'shortDate'}}</ion-label>\n          </ion-chip>\n\n          <ion-textarea [value]=\"mensaje.texto\" rows=\"1\"\n                        autoGrow=\"true\" color=\"dark\" mode=\"ios\" readonly=\"true\">\n\n          </ion-textarea>\n\n        </div>\n\n      </ion-col>\n\n    </ion-row>\n\n    <ion-row *ngIf=\"idUsuario == mensaje.usuario.id\">\n\n      <ion-col size=\"12\">\n\n        <div class=\"ion-text-end mensaje-propio\">\n\n          <ion-chip color=\"dark\" mode=\"ios\">\n            <ion-label>{{mensaje.fecha |  date: 'shortDate'}}</ion-label>\n          </ion-chip>\n          <ion-textarea [value]=\"mensaje.texto\" rows=\"1\"\n                        autoGrow=\"true\" color=\"dark\" mode=\"ios\" readonly=\"true\">\n\n          </ion-textarea>\n\n        </div>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_chat_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./chat.component.html */ "3dHE");
/* harmony import */ var _chat_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chat.component.scss */ "wMXp");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "TEn/");
...
ChatComponent.propDecorators = {
    mensajes: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    mensaje: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    idUsuario: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    content: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonContent"], { read: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonContent"], static: false },] }]
};
...
let ListadoProductosComponent = class ListadoProductosComponent {
    ...
    ngDoCheck() {
        if (this.opcion == "Platos") {
            this.productos = this.productos.filter(producto => producto.tipo == src_app_clases_empleado__WEBPACK_IMPORTED_MODULE_5__["TipoEmpleado"].Cocinero);
        }
        else if (this.opcion == "Bebidas") {
            this.productos = this.productos.filter(producto => producto.tipo == src_app_clases_empleado__WEBPACK_IMPORTED_MODULE_5__["TipoEmpleado"].Bartender);
        }
    }
    ngOnInit() {
...
class Mensaje {
    static CrearMensaje(id, texto, usuario, fecha) {
...
let FormProductoComponent = class FormProductoComponent {
    constructor(fb, productoService, imagenService, toastController, loadingController) {
        ...
        this.toastController = toastController;
        this.loadingController = loadingController;
        this.usuario = src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"].usuario;
        this.popoverOptions = {
            translucent: true,
            cancelText: "Cerrar",
            okText: "Guardar",
...
let UIVisualService = UIVisualService_1 = class UIVisualService {
    constructor(modalController, toastController, alertController, actionSheetController, popoverController, router) {
        this.modalController = modalController;
        this.toastController = toastController;
...
let DetallePedidoComponent = class DetallePedidoComponent {
    constructor(actionSheetController, modalController, UIVisual, pedidoService, router) {
        this.actionSheetController = actionSheetController;
        this.modalController = modalController;
        this.UIVisual = UIVisual;
        this.pedidoService = pedidoService;
    ...
    mostrarOpciones() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            src_app_services_uivisual_service__WEBPACK_IMPORTED_MODULE_7__["UIVisualService"].presentActionSheet('Cliente', {
                mostrarPlatos: { handler: src_app_services_uivisual_service__WEBPACK_IMPORTED_MODULE_7__["UIVisualService"].verPlatos, params: this.pedido.productos },
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _clases_mensaje__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../clases/mensaje */ "Gm1F");
/* harmony import */ var _angular_fire_database__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/fire/database */ "sSZD");
var MensajesService_1;




let MensajesService = MensajesService_1 = class MensajesService {
    constructor(firebase) {
        this.firebase = firebase;
    }
    crear(mensaje) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const fetch = new Promise(resolve => {
                this.firebase.database.ref('mensajes').on('value', (snapshot) => {
                    ...
                    snapshot.forEach((child) => {
                        var data = child.val();
                        mensajes.push(_clases_mensaje__WEBPACK_IMPORTED_MODULE_2__["Mensaje"].CrearMensaje(data.id, data.texto, data.usuario, data.fecha));
                    });
                    MensajesService_1.mensajes = mensajes;
                    resolve(MensajesService_1.mensajes);
                });
            });
            return fetch;
        });
    ...
    leerPorId(id) {
        return new Promise(resolve => {
            this.firebase.database.ref(`mensajes/${id}`).once('value').then(snapshot => {
                let data = snapshot.val();
                const mensaje = _clases_mensaje__WEBPACK_IMPORTED_MODULE_2__["Mensaje"].CrearMensaje(data.id, data.texto, data.usuario, data.fecha);
                resolve(mensaje);
            });
        });
    }
...
MensajesService = MensajesService_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], MensajesService);
...
/* harmony import */ var _chat_chat_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./chat/chat.component */ "3tD2");
...
let CodigoQRService = class CodigoQRService {
    ...
    generar(elemento, id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const imagenQR = yield this.imagenService.guardarImagen(imagen, `qr-${carpeta}`);
