...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'info-mesa/:id',
                loadChildren: () => Promise.all(/*! import() | info-mesa-info-mesa-module */[__webpack_require__.e("common"), __webpack_require__.e("info-mesa-info-mesa-module")]).then(__webpack_require__.bind(null, /*! ../info-mesa/info-mesa.module */ "+Hsv")).then(m => m.InfoMesaPageModule)
            },
            {
                path: 'sala-chat',
                loadChildren: () => Promise.all(/*! import() | sala-chat-sala-chat-module */[__webpack_require__.e("common"), __webpack_require__.e("sala-chat-sala-chat-module")]).then(__webpack_require__.bind(null, /*! ../sala-chat/sala-chat.module */ "j2q8")).then(m => m.SalaChatPageModule)
            },
            {
                path: '',
...
/* harmony import */ var src_app_services_roles_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/services/roles.service */ "0ceX");
...
let HomePage = class HomePage {
    constructor(rolService, authService, router, notifications, actionSheetController, pedidosService) {
