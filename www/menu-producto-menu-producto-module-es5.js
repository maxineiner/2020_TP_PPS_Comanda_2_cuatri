      ...
      var MenuProductoPage = /*#__PURE__*/function () {
        ...
        _createClass(MenuProductoPage, [{
          ...
          value: function ngDoCheck() {
            this.platos = src_app_services_producto_service__WEBPACK_IMPORTED_MODULE_7__["ProductoService"].productos.filter(function (producto) {
              return producto.tipo == src_app_clases_empleado__WEBPACK_IMPORTED_MODULE_4__["TipoEmpleado"].Cocinero;
            });
            this.bebidas = src_app_services_producto_service__WEBPACK_IMPORTED_MODULE_7__["ProductoService"].productos.filter(function (producto) {
              return producto.tipo == src_app_clases_empleado__WEBPACK_IMPORTED_MODULE_4__["TipoEmpleado"].Bartender;
            });
          }
        }, {
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            this.productoService.traerTodos().then(function (data) {
              console.log(data);
              _this.platos = data.filter(function (producto) {
                return producto.tipo == src_app_clases_empleado__WEBPACK_IMPORTED_MODULE_4__["TipoEmpleado"].Cocinero;
              });
              _this.bebidas = data.filter(function (producto) {
                return producto.tipo == src_app_clases_empleado__WEBPACK_IMPORTED_MODULE_4__["TipoEmpleado"].Bartender;
              });
            });
          }
